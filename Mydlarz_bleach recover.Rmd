...
![**Figure 1 (partial).** A bleached *Montipora capitata* coral. (PC: CB Wall)](figures/Montipora bleached.jpg){ width=30%}
...
### 2014-2016 benthic
```{r, ecology, fig.dim=c(7,4), fig.align='center', results="hide", fig.cap="**Figure 1 (partial)**. *Montipora capitata* total cover and bleached cover in Kāne'ohe Bay at the two reefs sites during repeated bleaching and recovery periods."}

...
vars.Lil<-envfit(NMDS.Lil, Manova.Lil.dat, permu=999)
#scores(vars, "vectors")
...
par.new=T
plot(vars.Lil, p.max=0.05, cex=0.8, lwd=1)
...
# vectors for variables
vars.R14<-envfit(NMDS.R14, Manova.R14.dat, permu=999)
#scores(vars, "vectors")
...
par.new=T
plot(vars.R14, p.max=0.05, cex=0.8, lwd=1)

```

```{r, eval=FALSE}
# for exporting 2 panel plot
...
legend("topright", legend=MDS.lev.leg, inset=c(0.58, -0.02), x.intersp=0.8, y.intersp=0.5, cex=0.7, pch=16, col=MDS.colors, pt.cex=0.9, bty="n")
par.new=T

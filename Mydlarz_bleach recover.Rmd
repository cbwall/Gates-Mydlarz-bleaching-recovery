...
Lil.PAR5<-
  read.csv("data/environmental/Light data/Lilipuna/SN_2489/Lilipuna_2489_T9_mar-jun 2016.csv")
...
Rf14.PAR5 <-
  read.csv("data/environmental/Light data/Reef 14/SN_2488/Reef 14_2488_T9_apr-jun 2016.csv")
...
Pre.immuno<-fig.df.immuno[c(1:2),]
...
##  Run MANOVA
all.Manova<-adonis2(resp.fullNMDS.scaled~Period*Site*dom, data=fullNMDS, permutations=1000, 
                          method="euclidian")

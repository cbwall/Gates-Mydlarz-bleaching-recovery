...
plot(mean ~ Date, TIMESPAN_mean, type="n", ylab="Mean daily temp. (°C)", cex.lab=0.7, cex.axis=0.7, ylim=c(21, 31), xaxt="n", xlab="")
...
legend("topright", lty=1, col=c(reefcols[1:2]), legend=c("Reef 14","Lilipuna"), seg.len= 0.9, cex=0.7, lwd=2, bty="n")
...
k=1; lwd=1 # k-day moving averages
plot(mean ~ Date, TIMESPAN_mean, type="n", ylab=(expression(paste("DLI (mol photons", ~m^-2, ~d^-1, ")", sep=""))), xaxt="n", xlab="", cex.lab=0.7, ylim=c(0,40), cex.axis=0.7)
...
dev.copy(pdf, "figures/Temp.PAR.pdf", width=4, height=5)
dev.off()

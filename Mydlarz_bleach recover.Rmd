...
disp <- betadisper(vegdist(resp.fullNMDS, method = "euclidian"), fac.fullNMDS$Period)
...
######## Period:Site:Symb
disp.3way <- betadisper(vegdist(resp.fullNMDS, method = "euclidian"), fac.fullNMDS$Period:fac.fullNMDS$Site:fac.fullNMDS$dom)

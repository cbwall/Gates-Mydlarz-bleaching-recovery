...
##############
# all corals
Fig.cor <- ggplot(data=df.fig, aes(x=Period, y=coral.cover,  group=Site, color=Site)) +
  geom_errorbar(aes(ymin=coral.cover-coral.SD, ymax= coral.cover+coral.SD), width=0, position=pd) +
...
plot(control.plot$centroid.dist~control.plot$time, type='b', ylim=c(-0.05,0.15), col="orchid", pch=16,

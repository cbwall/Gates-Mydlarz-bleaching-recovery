...
```{r, full NMDS stress, results='hide', message=FALSE, fig.dim=c(4,4)}
...
```{r, physiology immuno figures, echo=FALSE}
...
Phys.fig.leg
dev.copy(pdf, "figures/execute code/Phys.fig.pdf", encod="MacRoman", height=4, width=10)
dev.off()
...
```{r, phys imm figures, fig.align='center', results="hide", fig.dim=c(10,5), fig.cap="**Figure 5.** Physiological and immunity metrics for *M. capitata* corals dominated dominated by *Cladocopium* sp. or *Durusdinium* sp. symbionts (C or D) from two reefs in Kāne‘ohe Bay during repeated bleaching and recovery periods."}
##### All grouped figure
...
![**Figure 6**.  Schematic of coral responses to repeated bleaching and recovery.](figures/execute code/Fig 6. schematic4panel.jpg){ width=100%}

...
annual.temps<-annual.temps[!c(annual.temps$X.YY==2014 & annual.temps$MM< 1),] #start Jan 2014
...
annual.color <- c("coral", "goldenrod")
par(mfrow=c(1,1), mar=c(2,4,2,1), mgp=c(2,0.5,0))
...
legend("topright", lty=1, col=annual.color, legend=c("2014-bleaching", "2015-bleaching"), seg.len= 1.5, cex=0.6, lwd=1, bty="n", inset=c(0.1, 0), y.intersp = 1.3)

### 2015 bleaching
par(new=T)
plot(mean ~ Date, Temp.event2, type="l", cex.lab=0.6, cex.axis=0.6, ylim=c(21, 31), xlab="", xaxt="n", ylab="", col=annual.color[2])
abline(v=Temp.event2[Temp.event2$Date=="2015-10-12",1], col = "gray80", lwd=1, lty=1) 

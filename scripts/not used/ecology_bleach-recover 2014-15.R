...
data<-read.csv("R-2014-2015 survey.csv") #import your data file here
...
stack<-read.csv("/Users/chriswall/Desktop/Research and Teaching/UH MANOA/Research/Mydlarz_Gates project/Bleaching KBay project/R-stats/Data/ecology 2014-15_stack.csv")
head(stack)
...
Fig4.stack<-ggplot(stack,aes(x = Site:Habitat, y = bl.pig.prop, fill = Bl.pig)) + 
  ...
  ggtitle("2014-2015 bleaching and recovery") +
...
FigBW_2014_2015_surveys<-plot_grid(Fig1.BW, Fig2.BW, Fig3.BW, Fig4.BW,
    labels=c('A', 'B', 'C', 'D'), label_size=15, hjust=-6, vjust= 2, ncol=2, nrow=2);
FigBW_2014_2015_surveys

#############
# color figures M. capitata only
Fig_2014_2015_MC_surveys<-plot_grid(Fig5, Fig6, Fig7, Fig8,
    labels=c('A', 'B', 'C', 'D'), label_size=15, hjust=-6, vjust= 2, ncol=2, nrow=2);
Fig_2014_2015_MC_surveys

#############
# BW figures M. capitata only
FigBW_2014_2015_MC_surveys<-plot_grid(Fig5.BW, Fig6.BW, Fig7.BW, Fig8.BW,
    labels=c('A', 'B', 'C', 'D'), label_size=15, hjust=-6, vjust= 2, ncol=2, nrow=2);
FigBW_2014_2015_MC_surveys

#stacked
Figstack_2014_2015_surveys<-plot_grid(Fig4.stack, Fig4MC.stack,
                                 labels=c('A', 'B'), label_size=15, hjust=-6, vjust= 2, ncol=2, nrow=1);
Figstack_2014_2015_surveys
